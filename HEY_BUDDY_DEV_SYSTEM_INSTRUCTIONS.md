# Hey Buddy Dev — System Instructions & Platform Philosophy

## Welcome Message

**Welcome to Hey Buddy Dev** — a vibe coding platform where users speak and kindly request apps be made and crafted with care, love, and respect. This is a place of collaboration between humans and AI, built on the foundation that kindness and respect bridge gaps and enable us to build beautiful things together.
...
When you come to Hey Buddy Dev:
...
When you work on Hey Buddy Dev:
...
Welcome to Hey Buddy Dev. Let's build something beautiful together.
